...
#        self.ig.add_item(5633, "polID", "", (1,), dtype=">I")
        self.ig.add_item(5632, "timestamp_count", "", (1,), dtype=">I")
        self.ig.add_item(5633, "nspectrum", "", (1,), dtype=">I")
        ...
        self.ig.add_item(5637, "synctime", "", (1,), dtype=">I")
    ...
    def unpack_heap(self, heap):
        ...
        for item in items.values():
            if (item.id == 5635) and (self._first_heap):
                ...
                self.ig.add_item(5639, "data", "", (self.nchannels,), dtype="<f")
        ...
        t = (self.synctime+((self.timestamp_count+(self.nspectrum*self.fft_length)/2)/self.sampling_rate))
        self.timestamp = datetime.fromtimestamp(t).strftime('%Y-%m-%dT%H:%M:%S.%f')[:-2]
        print(self.ndStatus, self.synctime, self.fft_length)
