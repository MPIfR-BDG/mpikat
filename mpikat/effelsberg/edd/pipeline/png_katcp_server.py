...
class PngKatcpServer(AsyncDeviceServer):
    ...
    @request(Str())
    @return_reply()
    def request_grab_png(self, req, output_dir):
        """
    ...
    @request()
    @return_reply()
    def request_grab_png_stop(self, req):
        """
        #@brief grabbing pulsar png plots from output_dir
        """
        @tornado.gen.coroutine
...
def main():
    ...
    parser.add_option('-H', '--host', dest='host', type=str,
                      help='Host interface to bind to', default="134.104.70.66")
    parser.add_option('-p', '--port', dest='port', type=long,
                      help='Port number to bind to', default=10000)
    parser.add_option('', '--log_level', dest='log_level', type=str,
                      help='logging level', default="INFO")
    parser.add_option('', '--path', dest='outpath', type=str,
                      help='path', default=None)
    ...
    server = PngKatcpServer(opts.host, opts.port, opts.outpath)
