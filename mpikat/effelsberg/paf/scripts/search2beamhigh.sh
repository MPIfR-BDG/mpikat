...
python /mpikat/mpikat/core/scpi_client.py -H 134.104.64.51 -p 5004 -m "PAFBE:CMDMODE search2beamhigh" -t 20
python /mpikat/mpikat/core/scpi_client.py -H 134.104.64.51 -p 5004 -m "PAFBE:CMDZOOMBAND0 26" -t 20
